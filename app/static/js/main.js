...
var isHidden = function isHidden2(node, _ref) {
  var { displayCheck, getShadowRoot } = _ref;
  ...
  var nodeIsAttached = (nodeRootHost === null || nodeRootHost === undefined ? undefined : nodeRootHost.ownerDocument.contains(nodeRootHost)) || node.ownerDocument.contains(node);
...
var createFocusTrap = function createFocusTrap2(elements, userOptions) {
  ...
  var findContainerIndex = function findContainerIndex2(element) {
    return state.containerGroups.findIndex(function(_ref) {
      var { container, tabbableNodes } = _ref;
...
function src_default3(Alpine2) {
  ...
  function collapse(el, { modifiers }) {
    let duration = modifierValue2(modifiers, "duration", 250) / 1000;
...
function src_default4(Alpine2) {
  Alpine2.directive("mask", (el, { value, expression }, { effect: effect3, evaluateLater: evaluateLater2, cleanup: cleanup2 }) => {
    ...
    queueMicrotask(() => {
      if (["function", "dynamic"].includes(value)) {
        ...
        effect3(() => {
          templateFn = (input) => {
            let result;
            Alpine2.dontAutoEvaluateFunctions(() => {
              evaluator((value2) => {
